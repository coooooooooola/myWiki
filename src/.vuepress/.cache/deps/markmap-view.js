...
function selectAll_default3(select) {
  ...
  for (var groups2 = this._groups, m = groups2.length, subgroups = [], parents = [], j2 = 0; j2 < m; ++j2) {
    for (var group2 = groups2[j2], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children2 = select.call(node, node.__data__, i, group2), child, inherit2 = get2(node, id2), k3 = 0, l = children2.length; k3 < l; ++k3) {
...
function polygonContains_default(polygon, point6) {
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (var j2 = 0; j2 < m; ++j2, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
      var point1 = ring[j2], lambda1 = longitude(point1), phi1 = point1[1] / 2 + quarterPi, sinPhi1 = sin2(phi1), cosPhi1 = cos2(phi1), delta = lambda1 - lambda0, sign3 = delta >= 0 ? 1 : -1, absDelta = sign3 * delta, antimeridian = absDelta > pi4, k3 = sinPhi0 * sinPhi1;
      sum4.add(atan2(k3 * sign3 * sin2(absDelta), cosPhi0 * cosPhi1 + k3 * cos2(absDelta)));
...
function azimuthalRaw(scale2) {
  return function(x3, y3) {
    var cx = cos2(x3), cy = cos2(y3), k3 = scale2(cx * cy);
...
function dice_default(parent, x02, y0, x12, y1) {
  var nodes = parent.children, node, i = -1, n = nodes.length, k3 = parent.value && (x12 - x02) / parent.value;
  while (++i < n) {
    node = nodes[i], node.y0 = y0, node.y1 = y1;
    node.x0 = x02, node.x1 = x02 += node.value * k3;
  }
}
...
var gamma_default = function sourceRandomGamma(source) {
  ...
  function randomGamma(k3, theta) {
    ...
    if (k3 === 1) return () => -Math.log1p(-source()) * theta;
    var d = (k3 < 1 ? k3 + 1 : k3) - 1 / 3, c3 = 1 / (3 * Math.sqrt(d)), multiplier = k3 < 1 ? () => Math.pow(source(), 1 / k3) : () => 1;
    return function() {
      do {
        do {
...
var weibull_default = function sourceRandomWeibull(source) {
  function randomWeibull(k3, a2, b) {
    var outerFunc;
    if ((k3 = +k3) === 0) {
      outerFunc = (x3) => -Math.log(x3);
    } else {
      k3 = 1 / k3;
      outerFunc = (x3) => Math.pow(x3, k3);
    }
    a2 = a2 == null ? 0 : +a2;
    b = b == null ? 1 : +b;
    return function() {
...
var poisson_default = function sourceRandomPoisson(source) {
  ...
  function randomPoisson(lambda) {
    return function() {
      ...
      for (var s2 = -Math.log1p(-source()), k3 = 0; s2 <= l; ++k3) s2 -= Math.log1p(-source());
      return acc + k3;
    };
  }
...
function zoom_default2() {
  ...
  zoom.scaleBy = function(selection2, k3, p, event) {
    zoom.scaleTo(selection2, function() {
      var k0 = this.__zoom.k, k1 = typeof k3 === "function" ? k3.apply(this, arguments) : k3;
      return k0 * k1;
    }, p, event);
  };
  zoom.scaleTo = function(selection2, k3, p, event) {
    zoom.transform(selection2, function() {
      var e = extent2.apply(this, arguments), t03 = this.__zoom, p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t03.invert(p0), k1 = typeof k3 === "function" ? k3.apply(this, arguments) : k3;
...
// node_modules/.pnpm/markmap-view@0.18.5_markmap-common@0.18.5/node_modules/markmap-view/dist/index.js
var Z = typeof navigator < "u" && navigator.userAgent.includes("Macintosh");
var vt = ordinal(category10_default);
var q = {
  autoFit: false,
  color: (e) => {
    var t;
...
function ye(e) {
  ...
  if ((n == null ? void 0 : n.length) === 1) {
    ...
    const s2 = ordinal(n);
    t.color = (c3) => s2(`${c3.state.path}`);
  }
  if (o) {
    const s2 = t.color || q.color;
    t.color = (c3) => (c3 = {
      ...c3,
      state: {
        ...c3.state,
        path: c3.state.path.split(".").slice(0, o).join(".")
      }
    }, s2(c3));
  }
  return [
...
function wt(e) {
  var t = this, i, n = [t], o, a2, l;
  do
    for (i = n.reverse(), n = []; t = i.pop(); )
      if (e(t), o = t.children, o) for (a2 = 0, l = o.length; a2 < l; ++a2)
        n.push(o[a2]);
  while (n.length);
  return this;
}
...
function St(e) {
  for (var t = this, i = [t], n = [], o, a2, l; t = i.pop(); )
    if (n.push(t), o = t.children, o) for (a2 = 0, l = o.length; a2 < l; ++a2)
      i.push(o[a2]);
  for (; t = n.pop(); )
    e(t);
  return this;
...
function H(e, t) {
  var i = new j(e), n = +e.value && (i.value = e.value), o, a2 = [i], l, s2, c3, p;
  for (t == null && (t = Bt); o = a2.pop(); )
    if (n && (o.value = +o.data.value), (s2 = t(o.data)) && (p = s2.length))
      for (o.children = new Array(p), c3 = p - 1; c3 >= 0; --c3)
        a2.push(l = o.children[c3] = new j(s2[c3])), l.parent = o, l.depth = o.depth + 1;
...
var Ft = "d3-flextree";
var $t = "2.1.2";
var Nt = "build/d3-flextree.js";
var It = "index";
var Pt = { name: "Chris Maloney", url: "http://chrismaloney.org" };
var Wt = "Flexible tree layout algorithm that allows for variable node sizes.";
var Kt = ["d3", "d3-module", "layout", "tree", "hierarchy", "d3-hierarchy", "plugin", "d3-plugin", "infovis", "visualization", "2d"];
var Gt = "https://github.com/klortho/d3-flextree";
var Vt = "WTFPL";
var Ut = { type: "git", url: "https://github.com/klortho/d3-flextree.git" };
var Yt = { clean: "rm -rf build demo test", "build:demo": "rollup -c --environment BUILD:demo", "build:dev": "rollup -c --environment BUILD:dev", "build:prod": "rollup -c --environment BUILD:prod", "build:test": "rollup -c --environment BUILD:test", build: "rollup -c", lint: "eslint index.js src", "test:main": "node test/bundle.js", "test:browser": "node test/browser-tests.js", test: "npm-run-all test:*", prepare: "npm-run-all clean build lint test" };
var Zt = { "d3-hierarchy": "^1.1.5" };
var qt = { "babel-plugin-external-helpers": "^6.22.0", "babel-preset-es2015-rollup": "^3.0.0", d3: "^4.13.0", "d3-selection-multi": "^1.0.1", eslint: "^4.19.1", jsdom: "^11.6.2", "npm-run-all": "^4.1.2", rollup: "^0.55.3", "rollup-plugin-babel": "^2.7.1", "rollup-plugin-commonjs": "^8.0.2", "rollup-plugin-copy": "^0.2.3", "rollup-plugin-json": "^2.3.0", "rollup-plugin-node-resolve": "^3.0.2", "rollup-plugin-uglify": "^3.0.0", "uglify-es": "^3.3.9" };
var Jt = {
  name: Ft,
  version: $t,
  main: Nt,
...
function Q(e) {
  ...
  function n(s2) {
    const c3 = l(a2(), s2, (p) => p.children);
    return c3.update(), c3.data;
  }
  function o() {
    const s2 = i("nodeSize"), c3 = i("spacing");
    return class J extends H.prototype.constructor {
      constructor(h) {
        super(h);
      }
      copy() {
        const h = l(this.constructor, this, (u4) => u4.children);
      ...
      get extents() {
        return (this.children || []).reduce(
          (h, u4) => J.maxExtents(h, u4.extents),
          this.nodeExtents
        );
      }
      get nodeExtents() {
  ...
  function a2() {
    const s2 = o(), c3 = i("nodeSize"), p = i("spacing");
  ...
  function l(s2, c3, p) {
    const h = (u4, g) => {
      ...
      const y3 = p(u4) || [];
      return m.children = y3.length === 0 ? null : y3.map((f) => h(f, m)), m.children && Object.assign(m, m.children.reduce(
        (f, b) => ({
  ...
  return Object.assign(n, {
    nodeSize(s2) {
      return arguments.length ? (t.nodeSize = s2, n) : t.nodeSize;
    },
    spacing(s2) {
      return arguments.length ? (t.spacing = s2, n) : t.spacing;
    },
    children(s2) {
      return arguments.length ? (t.children = s2, n) : t.children;
    },
    hierarchy(s2, c3) {
      const p = typeof c3 > "u" ? t.children : c3;
      return l(o(), s2, p);
    },
    dump(s2) {
      const c3 = i("nodeSize"), p = (h) => (u4) => {
        const g = h + "  ", m = h + "    ", { x: y3, y: f } = u4, b = c3(u4), v2 = u4.children || [], w = v2.length === 0 ? " " : `,${g}children: [${m}${v2.map(p(m)).join(m)}${g}],${h}`;
        return `{ size: [${b.join(", ")}],${g}x: ${y3}, y: ${f}${w}},`;
      };
      return p(`
`)(s2);
    }
...
Q.version = Qt;
var tt = (e, t = 0) => (e.y = t, (e.children || []).reduce((i, n) => {
  const [o, a2] = i;
  tt(n, e.y + e.ySize);
...
var ee = (e) => {
  (e.children || []).reduce((t, i) => {
    const [n, o] = t, a2 = n + i.shift, l = o + a2 + i.change;
    return i.relX += l, [a2, l];
  }, [0, 0]);
};
var re2 = (e, t, i) => {
  const n = e.children[t - 1], o = e.children[t];
  let a2 = n, l = n.relX, s2 = o, c3 = o.relX, p = true;
  for (; a2 && s2; ) {
    a2.bottom > i.lowY && (i = i.next);
    const h = l + a2.prelim - (c3 + s2.prelim) + a2.xSize / 2 + s2.xSize / 2 + a2.spacing(s2);
    (h > 0 || h < 0 && p) && (c3 += h, ne(o, h), ie(e, t, i.index, h)), p = false;
    const u4 = a2.bottom, g = s2.bottom;
    u4 <= g && (a2 = oe(a2), a2 && (l += a2.relX)), u4 >= g && (s2 = se(s2), s2 && (c3 += s2.relX));
  }
  !a2 && s2 ? ae(e, t, s2, c3) : a2 && !s2 && le(e, t, a2, l);
};
var ne = (e, t) => {
  e.relX += t, e.lExtRelX += t, e.rExtRelX += t;
};
var ie = (e, t, i, n) => {
  const o = e.children[t], a2 = t - i;
  if (a2 > 1) {
    const l = n / a2;
    e.children[i + 1].shift += l, o.shift -= l, o.change -= n - l;
  }
};
var se = (e) => e.hasChildren ? e.firstChild : e.lThr;
var oe = (e) => e.hasChildren ? e.lastChild : e.rThr;
var ae = (e, t, i, n) => {
  const o = e.firstChild, a2 = o.lExt, l = e.children[t];
  a2.lThr = i;
  const s2 = n - i.relX - o.lExtRelX;
  a2.relX += s2, a2.prelim -= s2, o.lExt = l.lExt, o.lExtRelX = l.lExtRelX;
};
var le = (e, t, i, n) => {
  const o = e.children[t], a2 = o.rExt, l = e.children[t - 1];
  a2.rThr = i;
  const s2 = n - i.relX - o.rExtRelX;
  a2.relX += s2, a2.prelim -= s2, o.rExt = l.rExt, o.rExtRelX = l.rExtRelX;
};
var ce2 = (e) => {
  if (e.hasChildren) {
...
var nt = class _nt {
  constructor(t, i) {
    this.options = q, this._disposeList = [], this.handleZoom = (n) => {
      ...
      (Z ? n.metaKey : n.ctrlKey) && (a2 = !a2), this.toggleNode(o, a2);
...
`);
  ...
  _initializeData(t) {
    ...
    let a2 = 0, l = 0;
    return walkTree(t, (s2, c3, p) => {
      var u4, g, m, y3;
      l += 1, s2.children = (u4 = s2.children) == null ? void 0 : u4.map((f) => ({ ...f })), i += 1, s2.state = {
        ...s2.state,
        depth: l,
        id: i,
        rect: {
        ...
        size: [0, 0]
      }, s2.state.key = [(g = p == null ? void 0 : p.state) == null ? void 0 : g.id, s2.state.id].filter(Boolean).join(".") + bt(s2.content), s2.state.path = [(m = p == null ? void 0 : p.state) == null ? void 0 : m.path, s2.state.id].filter(Boolean).join("."), n(s2);
      const h = ((y3 = s2.payload) == null ? void 0 : y3.fold) === 2;
      h ? a2 += 1 : (a2 || o >= 0 && s2.state.depth >= o) && (s2.payload = { ...s2.payload, fold: 1 }), c3(), h && (a2 -= 1), l -= 1;
    }), t;
  }
  _relayout() {
    if (!this.state.data) return;
    this.g.selectAll(k2(O)).selectAll(
      k2("foreignObject")
    ).each(function(s2) {
      var h;
      const c3 = (h = this.firstChild) == null ? void 0 : h.firstChild, p = [c3.scrollWidth, c3.scrollHeight];
      s2.state.size = p;
    });
    const { spacingHorizontal: t, paddingX: i, spacingVertical: n } = this.options, o = Q({}).children((s2) => {
      var c3;
      if (!((c3 = s2.payload) != null && c3.fold)) return s2.children;
    }).nodeSize((s2) => {
      const [c3, p] = s2.data.state.size;
      return [p, c3 + (c3 ? i * 2 : 0) + t];
    }).spacing((s2, c3) => s2.parent === c3.parent ? n : n * 2), a2 = o.hierarchy(this.state.data);
    o(a2);
    const l = a2.descendants();
    l.forEach((s2) => {
      const c3 = s2.data;
      c3.state.rect = {
        x: s2.y,
      ...
      x1: min(l, (s2) => s2.data.state.rect.x) || 0,
      y1: min(l, (s2) => s2.data.state.rect.y) || 0,
      x2: max(
        l,
        (s2) => s2.data.state.rect.x + s2.data.state.rect.width
      ) || 0,
      y2: max(
        l,
        (s2) => s2.data.state.rect.y + s2.data.state.rect.height
      ) || 0
    };
  }
  setOptions(t) {
  ...
  _getHighlightRect(t) {
    const i = this.svg.node(), o = 4 / transform(i).k, a2 = {
      ...t.state.rect
    };
    return a2.x -= o, a2.y -= o, a2.width += 2 * o, a2.height += 2 * o, a2;
  }
  async renderData(t) {
    const { paddingX: i, autoFit: n, color: o, maxWidth: a2 } = this.options, l = this.state.data;
    if (!l) return;
    const s2 = {}, c3 = {}, p = [];
    walkTree(l, (r, d, x3) => {
      var E2;
      (E2 = r.payload) != null && E2.fold || d(), s2[r.state.id] = r, x3 && (c3[r.state.id] = x3.state.id), p.push(r);
    });
    const h = {}, u4 = {}, g = (r) => {
      !r || h[r.state.id] || walkTree(r, (d, x3) => {
        h[d.state.id] = r.state.id, x3();
      });
    }, m = (r) => u4[h[r.state.id]] || l.state.rect, y3 = (r) => (s2[h[r.state.id]] || l).state.rect;
    u4[l.state.id] = l.state.rect, t && g(t);
    const { highlight: f } = this.state;
    let b = this.g.selectAll(k2(pe)).selectAll(k2("rect")).data(f ? [this._getHighlightRect(f)] : []).join("rect").attr("x", (r) => r.x).attr("y", (r) => r.y).attr("width", (r) => r.width).attr("height", (r) => r.height);
    const v2 = this.g.selectAll(k2(O)).each((r) => {
      u4[r.state.id] = r.state.rect;
    }).data(p, (r) => r.state.key), w = v2.enter().append("g").attr("data-depth", (r) => r.state.depth).attr("data-path", (r) => r.state.path).each((r) => {
      g(s2[c3[r.state.id]]);
    }), C3 = v2.exit().each((r) => {
      g(s2[c3[r.state.id]]);
    }), S = v2.merge(w).attr(
    ...
    ), B3 = S.selectAll(k2("line")).data(
      (r) => [r],
      (r) => r.state.key
    ), L = B3.enter().append("line").attr("stroke", (r) => o(r)).attr("stroke-width", 0), D3 = B3.merge(L), F = S.selectAll(k2("circle")).data(
      (r) => {
        var d;
    ...
    ), N = this._observer, I = S.selectAll(k2("foreignObject")).data(
      (r) => [r],
      (r) => r.state.key
    ...
    const W = _.merge(I), it = p.flatMap(
      (r) => {
        var d;
        return (d = r.payload) != null && d.fold ? [] : r.children.map((x3) => ({ source: r, target: x3 }));
      }
    ), M2 = this.g.selectAll(k2(de2)).data(it, (r) => r.target.state.key), st = M2.exit(), ot = M2.enter().insert("path", "g").attr("class", "markmap-link").attr("data-depth", (r) => r.target.state.depth).attr("data-path", (r) => r.target.state.path).attr("d", (r) => {
      const d = m(r.target), x3 = [
        d.x + d.width,
        d.y + d.height
      ];
      return A5({ source: x3, target: x3 });
    }).attr("stroke-width", 0).merge(M2);
    this.svg.style(
      "--markmap-max-width",
      a2 ? `${a2}px` : null
      ...
      const d = y3(r), x3 = d.x + d.width - r.state.rect.width, E2 = d.y + d.height - r.state.rect.height;
      return `translate(${x3},${E2})`;
    }).remove(), this.transition(S).attr(
      "transform",
      (r) => `translate(${r.state.rect.x},${r.state.rect.y})`
    );
    const at = C3.selectAll(
      k2("line")
    );
    this.transition(at).attr("x1", (r) => r.state.rect.width).attr("stroke-width", 0), L.attr("x1", (r) => r.state.rect.width).attr("x2", (r) => r.state.rect.width), D3.attr("y1", (r) => r.state.rect.height).attr("y2", (r) => r.state.rect.height), this.transition(D3).attr("x1", -1).attr("x2", (r) => r.state.rect.width + 2).attr("stroke", (r) => o(r)).attr("stroke-width", V);
  ...
  async fit(t = this.options.maxInitialScale) {
    const i = this.svg.node(), { width: n, height: o } = i.getBoundingClientRect(), { fitRatio: a2 } = this.options, { x1: l, y1: s2, x2: c3, y2: p } = this.state.rect, h = c3 - l, u4 = p - s2, g = Math.min(
      n / h * a2,
      o / u4 * a2,
      t
  ...
  findElement(t) {
    let i;
    return this.g.selectAll(k2(O)).each(function(o) {
      o === t && (i = {
        data: o,
        g: this
      });
  ...
  async ensureVisible(t, i) {
    ...
    if (!n) return;
    const o = this.svg.node(), a2 = o.getBoundingClientRect(), l = transform(o), [s2, c3] = [
      n.state.rect.x,
      n.state.rect.x + n.state.rect.width + 2
    ].map((v2) => v2 * l.k + l.x), [p, h] = [
      n.state.rect.y,
      n.state.rect.y + n.state.rect.height
    ].map((v2) => v2 * l.k + l.y), u4 = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0,
      ...i
    }, g = [u4.left - s2, a2.width - u4.right - c3], m = [u4.top - p, a2.height - u4.bottom - h], y3 = g[0] * g[1] > 0 ? U(g, Math.abs) / l.k : 0, f = m[0] * m[1] > 0 ? U(m, Math.abs) / l.k : 0;
    if (y3 || f) {
      const v2 = l.translate(y3, f);
      return this.transition(this.svg).call(this.zoom.transform, v2).end().catch(noop);
    }
  }
  async centerNode(t, i) {
    var y3;
    const n = (y3 = this.findElement(t)) == null ? void 0 : y3.data;
    if (!n) return;
    const o = this.svg.node(), a2 = o.getBoundingClientRect(), l = transform(o), s2 = (n.state.rect.x + n.state.rect.width / 2) * l.k + l.x, c3 = (n.state.rect.y + n.state.rect.height / 2) * l.k + l.y, p = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0,
      ...i
    }, h = (p.left + a2.width - p.right) / 2, u4 = (p.top + a2.height - p.bottom) / 2, g = (h - s2) / l.k, m = (u4 - c3) / l.k;
    if (g || m) {
      const f = l.translate(g, m);
      return this.transition(this.svg).call(this.zoom.transform, f).end().catch(noop);
    }
  }
  /**
   ...
   */
  async rescale(t) {
    const i = this.svg.node(), { width: n, height: o } = i.getBoundingClientRect(), a2 = n / 2, l = o / 2, s2 = transform(i), c3 = s2.translate(
      (a2 - s2.x) * (1 - t) / s2.k,
      (l - s2.y) * (1 - t) / s2.k
    ).scale(t);
